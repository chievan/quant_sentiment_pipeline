...
FOF_RULES = {
    "STYLE_FACTOR": {
        "keywords": ["大小盘", "微盘", "小市值", "小盘股", "大盘股", "权重股", "抱团", "红利", "风格切换", "因子拥挤", "超额回撤", "出清", "超调", "风格漂移", "中证500", "中证1000", "沪深300", "微盘股", "哑铃交易", "杠铃策略", "红利哑铃", "方锥", "多因子", "风格因子", "因子回撤", "拥挤度", "行业暴露", "多因子模型"],
        "name": "市场结构与风格因子",
        "description": "监控量化风格拥挤度、大小盘风格轮动（如沪深300 vs 中证1000/微盘股走势）、红利哑铃/方锥策略漂移以及多因子/风格因子的回撤情况。"
    },
    "BETA_TIMING": {
    ...
    "HEDGE_COST": {
        "keywords": ["基差", "贴水", "股指期货", "对冲", "期权", "升水", "主力合约", "国债期货", "IC合约", "IM合约", "IF合约", "雪球对冲", "雪球敲入", "Delta对冲", "券商对冲", "敲出", "敲入", "分红贴水", "除权除息", "分红季", "移仓换月", "移仓成本", "滚贴水", "吃贴水", "融券", "转融通", "券源", "近月合约", "远月合约", "奇异期权"],
        "name": "市场中性与对冲基差",
        "description": "监控股指期货（IC/IF/IM）基差贴水、分红贴水、移仓换月损耗，以及雪球期权对冲盘（敲入/敲出风险）与融券券源政策对中性策略的影响。"
    },
    "HFT_REGULATION": {
        "keywords": ["高频", "T0", "换手", "成交额", "地量", "巨量", "程序化交易", "量化监管", "算法交易", "报单", "撤单", "交易规则", "万亿", "两市成交", "DMA", "高频交易限制", "撤单费", "异常交易", "中基协", "证监会", "封盘", "幻方", "九章", "灵均", "鸣石", "九坤", "衍复", "明汯", "量化大厂", "私募巨头"],
        "name": "T0中性与高频流动性",
        "description": "监控全市场成交量级（地量/巨量）、换手率以及量化/程序化/高频交易的政策监管变动与头部量化机构的行为变动（如封盘、规模变动）。"
    },
    "CTA_TREND": {
